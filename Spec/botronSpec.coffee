...
describe "botron", ->
    ...
    it "can have a frame loaded into it", ->
        frame = common.newPlan parts.frames['basic']
        botron.loadFrame bot, frame
        expect(bot.frame.code).toEqual 'basic'


    xit "cant have a module loaded as a frame", =>
        botron.loadFrame bot, common.newPlan parts.frames['armatures/grabber']

    it "has a frame specified module type capacity limit", ->
        botron.loadFrame bot, common.newPlan parts.frames['basic']
        expect(bot.frame.max.sensors).toEqual 2

    it "can have equipment module loaded into its frame", ->
        botron.loadFrame bot, common.newPlan parts.frames['basic']
        botron.loadModule bot, common.newPlan parts.modules['sensors/sight/basic']
        expect(bot.frame.modules[0].code).toEqual 'sensors/sight/basic'
    ...
    #     botron.loadFrame bot, common.newPlan parts.frames['basic']
    #     botron.loadModule bot, common.newPlan parts.modules['sensors/sight/basic']
    #     botron.loadModule bot, common.newPlan parts.modules['armatures/grabber']
    #     botron.loadModule bot, common.newPlan parts.modules['hopper/basic/general']
    #     module = botron.getModule bot, 'armatures/grabber'
    #     console.log module
    #
    #     expect(module.code).toEqual 'armatures/grabber'
    ...
    it "can have a resource harvesting tool", ->
        botron.loadFrame bot, common.newPlan parts.frames['basic']
        botron.loadModule bot, common.newPlan parts.modules['armatures/grabber']
        expect(bot.frame.modules[0].code).toEqual 'armatures/grabber'


    xit "can not harvest wtihout a harvesting tool", ->
    ...
    it "will harvest resources according to all the tools available", ->
        ...
        botron.loadModule bot, common.newPlan parts.modules['sensors/sight/basic']
        botron.loadModule bot, common.newPlan parts.modules['armatures/grabber']
        botron.loadModule bot, common.newPlan parts.modules['armatures/mower']
    ...
    it "can have a hopper", ->
        botron.loadFrame bot, common.newPlan parts.frames['basic']
        botron.loadModule bot, common.newPlan parts.modules['hoppers/general/basic']
        expect(bot.frame.modules[0].code).toEqual('hoppers/general/basic');
